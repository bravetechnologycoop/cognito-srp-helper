import type { AdminInitiateAuthRequest, AdminInitiateAuthResponse, AdminRespondToAuthChallengeRequest, AdminRespondToAuthChallengeResponse, AuthFlowType, ChallengeNameType, DeviceSecretVerifierConfigType, InitiateAuthRequest as ClientInitiateAuthRequest, InitiateAuthResponse as ClientInitiateAuthResponse, RespondToAuthChallengeRequest as ClientRespondToAuthChallengeRequest, RespondToAuthChallengeResponse as ClientRespondToAuthChallengeResponse } from "@aws-sdk/client-cognito-identity-provider";
/**
 ...
 */
export type InitiateAuthRequest = (Omit<ClientInitiateAuthRequest, "AuthFlow"> & {
 ...
 */
export type InitiateAuthResponse = (Omit<ClientInitiateAuthResponse, "ChallengeName"> & {
 ...
 */
export type RespondToAuthChallengeRequest = (Omit<ClientRespondToAuthChallengeRequest, "ChallengeName"> & {
    ChallengeName?: ChallengeNameType | string;
 ...
 */
export type RespondToAuthChallengeResponse = (Omit<ClientRespondToAuthChallengeResponse, "ChallengeName"> & {
    ChallengeName?: ChallengeNameType | string;
